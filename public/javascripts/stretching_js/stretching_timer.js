...
function check() {
    ...
    document.getElementById("today").innerHTML="접속시간 "+ hours + "시" + print_minutes + "분" + print_seconds + "초";
    document.getElementById("sec").innerHTML="스트레칭 안한지 벌써 "+ now_hours + "시" + print_now_minutes + "분" + print_now_seconds + "초";
